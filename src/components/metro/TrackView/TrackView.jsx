...
class TrackView extends Component {
    ...
    updateDimensions() {
        ...
        const cellsBBtop = this.rowRefs[0].cellsDivRef.current.getBoundingClientRect();
        const cellsBBbottom = this.rowRefs[3].cellsDivRef.current.getBoundingClientRect();
        ...
        const left = this.rowRefs[0].cellsDivRef.current.offsetLeft;
        indicator.minLeft = this.rowRefs[0].cellsDivRef.current.offsetLeft;
        const right = left + this.rowRefs[0].cellsDivRef.current.offsetWidth;
            ...
            <SimplePanel style={{ padding: '15px' }} title={Tr("Sequencer")}>
                <div className="trackView">
                    <div className="trackContainer">
                        <div className="indicator" ref={this.indicatorRef} style={{ left: indicatorProgress }} />
                        {
